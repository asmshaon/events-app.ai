...
<body style="margin:0;padding:0;background:#f4f4f5;font-family:Arial,Helvetica,sans-serif;color:#18181b;">
    <div style="max-width:560px;margin:0 auto;padding:24px;">
        <div style="background:#ffffff;border:1px solid #e4e4e7;border-radius:12px;padding:28px;">
            <h1 style="margin:0 0 8px;font-size:20px;">Starting in {{ $leadTime }} ⏰</h1>
            <p style="margin:0 0 20px;color:#52525b;">Hi {{ $attendeeName }}, this is a reminder for your upcoming event.</p>
            ...
            <p style="margin:24px 0 0;color:#52525b;font-size:13px;">Looking forward to seeing you!</p>
        </div>
    </div>
</body>
</html>
